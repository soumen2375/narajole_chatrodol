...
export class ImpactsComponent {
  ...
  successStories = signal([
    {
      title: 'আলিমুরের শিক্ষাজীবন: অন্ধকার থেকে আলো',
      summary: 'আলিমুর, একজন দরিদ্র পরিবারের সন্তান, নাড়াজোল ছাত্রদলের শিক্ষাবৃত্তির মাধ্যমে তার প্রাথমিক ও মাধ্যমিক শিক্ষা সম্পন্ন করেছে। বর্তমানে সে একটি বিশ্ববিদ্যালয়ে কম্পিউটার সায়েন্স নিয়ে পড়ছে এবং তার পরিবারের প্রথম স্নাতক হতে চলেছে।',
