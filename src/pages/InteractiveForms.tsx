...
export default function InteractiveForms() {
  return (
    <PageShell>
      ...
      {/* Header */}
      <section className="bg-slate-950 text-white py-12 px-6 sm:px-10 text-center border-b border-white/10">
        <div className="mx-auto max-w-4xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-indigo-400 mb-4 backdrop-blur-md">
      ...
      <section className="bg-slate-950 py-12 px-4 sm:px-8 md:px-12 min-h-screen">
