...
export default function MemberLayout() {
  ...
  const items: NavItem[] = [
    ...
    ...(canManageFinance ? [
      ...
      { to: '/member/budgets',              label: 'Budgets',             icon: Scale } as NavItem,
      ...
      { to: '/member/campaigns',            label: 'Campaigns',           icon: Megaphone } as NavItem,
      { to: '/member/refunds',              label: 'Refunds',             icon: Undo2 } as NavItem,
      { to: '/member/payroll',              label: 'Payroll',             icon: Coins } as NavItem,
