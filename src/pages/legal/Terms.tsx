  ...
  return (
    <LegalLayout title="Terms & Conditions">
      ...
      <Section heading="1. About us">
        <p>
          The Organisation is a non-profit, non-trading public charitable trust working in the fields of education,
      ...
      <Section heading="2. Eligibility & accounts">
        <List
          items={[
            'There is no public self–registration. Member and administrator accounts are created and approved only by the Organisation’s administrators.',
      ...
      <Section heading="3. Donations">
        <List
          items={[
            'All donations are entirely voluntary and are used to further the charitable objects of the Organisation.',
            ...
            'Any tax exemption on donations is subject to the Organisation holding the relevant registrations under the Income Tax Act, 1961, and applicable law.',
          ]}
        />
      </Section>
      ...
      <Section heading="5. Member-submitted content">
        <p>
          ...
          or have the right to share it and grant the Organisation a licence to display it on this website and its
          official channels.
        </p>
      </Section>
      ...
      <Section heading="6. Intellectual property">
        <p>
          ...
          content), is the property of the Organisation and is protected by applicable laws. You may not reproduce or
      ...
      <Section heading="7. Limitation of liability">
        <p>
          ...
          Organisation shall not be liable for any indirect, incidental or consequential loss arising from the use of,
