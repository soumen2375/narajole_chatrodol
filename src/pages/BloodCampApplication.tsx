                ...
                <div className="space-y-3.5">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3.5">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white border border-stone-200/80 text-[#c2410c] shadow-sm">
                        <item.icon className="h-4 w-4" />
                      </div>
                      <div>
                        <h4 className="font-bengali text-sm font-bold text-stone-900">{item.title}</h4>
                        <p className="font-bengali text-xs text-stone-500 mt-0.5">{item.sub}</p>
                      </div>
                    </div>
                  ))}
                </div>
